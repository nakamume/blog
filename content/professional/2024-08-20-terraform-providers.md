...
date: 2024-08-20
tags: ["2024-08", "2024", "terraform", "provider", "honeycomb"]
draft: false
---
I had a requirement where I wanted to work with Honeycombio's terraform provider. Unlike Datadog, Honeycomb has the concept of environments. It maps perfectly with our infra <!--more-->environments, i.e we can send prd telemetry to prd honeycomb environment and dev to dev.
...
> **Note:** We could, of couse, modify the tooling to support this Honeycomb case in a similar way. But that didn't sound like a good idea. As it sets the precedent of doing this for all the providers we use or will use.
